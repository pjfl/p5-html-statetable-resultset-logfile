package HTML::StateTable::ResultSet::Logfile::View;
...
HTML::StateTable::ResultSet::Logfile::View - Create result objects
...
Creates result objects for each line in the selected logfile
